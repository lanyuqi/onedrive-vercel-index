...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'luoqingyu@luoqingyu.onmicrosoft.com',
  ...
  title: "Luoqingyu's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Public/movie',
  ...
  email: 'mailto:leetingbai@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/lanyuqi/onedrive-vercel-index',
    },
  ],
